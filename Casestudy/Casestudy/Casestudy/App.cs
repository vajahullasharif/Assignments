...
namespace Casestudy
{
    ...
    class App
    {
        ...
        {
            Student student = new Student(1011, "vajahulla", "28/5/2000");
        ...
        public void Scenerio2()
        {
            ...
            students[0] = new Student(1234, "Sai", "12/4/1998");
            students[1] = new Student(2345, "Vajahulla", "18/01/1999");
        ...
        {
            Course course = new Course(107, "Sharif", 30, 15000.00f);
            info.display(course);
        }
